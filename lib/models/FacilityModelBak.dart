...
*/
  ...
  factory FacilityModel.fromJson(Map<String, dynamic> json){
    return FacilityModel(
        ...
        forge_2d_url: json["forge_2d_url"],
        forge_3d_url: json["forge_3d_url"],
        forge_element_id: json["forge_element_id"],
        coordinates_2d: json["coordinates_2d"],
        children_name: json["children_name"]
